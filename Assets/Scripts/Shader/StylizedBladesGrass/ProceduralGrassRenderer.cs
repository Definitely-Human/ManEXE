...
namespace ManExe.Shader.StylizedBladesGrass
{
    [ExecuteInEditMode]
    public class ProceduralGrassRenderer : MonoBehaviour
    {
        ...
        public void SetupVars(Mesh mesh, ComputeShader shader, Material material, GrassSettings grassSettings)
        {
            sourceMesh = mesh;
            grassComputeShader = shader;
